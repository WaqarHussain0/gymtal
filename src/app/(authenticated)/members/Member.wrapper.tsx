...
const MemberWrapper: React.FC<IMemberWrapper> = ({
  members,
  meta,
  currentPage,
}) => {
    ...
    <div className="w-full space-y-3">
      <Row className="justify-between flex-col md:flex-row items-start md:items-center space-y-3 md:space-y-0">
        <Row className="flex-col items-start">
          <TextElement as="h3" className="font-semibold">
            Members
          </TextElement>
        ...
        <Button
          className="bg-blue-900 hover:bg-blue-800 text-primary-foreground"
          onClick={() => router.push(PAGE_ROUTES.createMember)}
        >

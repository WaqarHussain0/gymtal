            ...
            >
                <div className="flex flex-col h-full space-y-3">
                    ...
                    <div className="flex items-center gap-3 px-2 py-3 border-b border-blue-800">
                        ...
                        <div>
                            <TextElement as="h1" className="font-semibold text-xl text-primary-foreground">
                                Gymtal
                            </TextElement>
                            <TextElement as="p" className="font-body text-xs text-primary-foreground/60">
                                Gym Management
                            </TextElement>
                        </div>
                    </div>
                        ...
                        {navigation.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={`flex items-center text-sm gap-3 px-4 py-2 rounded-sm transition-colors font-body ${isActive
